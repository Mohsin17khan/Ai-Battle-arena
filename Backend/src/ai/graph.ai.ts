...
const judgeNode: GraphNode<typeof state> = async (state) => {
    ...
    const judge = createAgent({
        ...
        systemPrompt: `You are a judge tasked with evaluating
         two solutions to a problem. The problem
          is: ${problem}. The first solution is: ${solution_1}.
           The second solution is: ${solution_2}. 
           Please evaluate the two solutions and provide
            a score out of 10 for each, along with your 
